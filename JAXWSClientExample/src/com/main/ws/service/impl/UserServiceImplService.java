 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://impl.service.ws.main.com/", wsdlLocation = "http://localhost:8888/user-service?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICEIMPLSERVICE_QNAME = new QName("http://impl.service.ws.main.com/", "UserServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8888/user-service?wsdl");
    ...
    public UserService getUserServiceImplPort() {
        return super.getPort(new QName("http://impl.service.ws.main.com/", "UserServiceImplPort"), UserService.class);
    }
    ...
    public UserService getUserServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.ws.main.com/", "UserServiceImplPort"), UserService.class, features);
    }
